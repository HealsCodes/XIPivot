...
#ifndef __ASHITA_SDK_FFXI_ENTITY_H_INCLUDED__
#define __ASHITA_SDK_FFXI_ENTITY_H_INCLUDED__
...
namespace Ashita::FFXI
{
    ...
    struct entity_t
    {
        ...
        uint8_t         Unknown0012;            // Unknown
        uint8_t         Unknown0013;            // Unknown
        ...
        uint8_t         Unknown0021;            // Unknown [Animation related flag, unsure of the use.]
        ...
        uint16_t        Unknown0022;            // Unknown [Assumed emote related, does not appear to be used.]
        ...
        uint32_t        Unknown0023;            // Unknown [Emote related, set and read when an emote is used.]
        ...
        uint8_t         Unknown0024[12];        // Unknown
        ...
        uint16_t        Unknown0025;            // Unknown
        int8_t          Unknown0026;            // Unknown [Flag used to determine if a forced update of the entities info is required.. Sends 0x16 packet if < 0.]
        ...
        float           Unknown0028;            // Unknown [Set from player updates, value is (uint8_t)data * 0.10]
        ...
        uint8_t         Unknown0030;            // Unknown [Forced to 0 when the monstrosity name is set.]
        uint8_t         MonstrosityNameAbbr[24];// The entities monstrosity name abbreviation.
        uint8_t         Unknown0031[3];         // Unknown
        uint8_t         Unknown0032[44];        // Unknown
        uint8_t         Unknown0033[36];        // Unknown
        ...
        uint16_t        Unknown0034;            // Unknown
        uint16_t        Unknown0035;            // Unknown [Set to a target index based on the last action / selection arrow target.]
        uint32_t        Unknown0036;            // Unknown
    };

}; // namespace Ashita::FFXI

#endif // __ASHITA_SDK_FFXI_ENTITY_H_INCLUDED__