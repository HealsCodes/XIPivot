...
#ifndef __ASHITA_SDK_FFXI_PARTY_H_INCLUDED__
#define __ASHITA_SDK_FFXI_PARTY_H_INCLUDED__
...
namespace Ashita::FFXI
{
    ...
    struct partymember_t
    {
        ...
        uint16_t    Unknown0001;            // Unknown (Deals with the visibility of the party member entry.)
        uint16_t    Unknown0002;            // Unknown (Usually 0, 4 when in party with a trust.)
...
#endif // __ASHITA_SDK_FFXI_PARTY_H_INCLUDED__