...
#ifndef __ASHITA_SDK_IMGUI_H_INCLUDED__
#define __ASHITA_SDK_IMGUI_H_INCLUDED__
...
// https://github.com/ocornut/imgui/tree/a2454f2a45ea016443411fcf69a971e9b1d650f6
//
////////////////////////////////////////////////////////////////////////////////////////////////////
//
...
interface IGuiManager
{
    ...
    virtual ImGuiContext* CreateContext(ImFontAtlas* shared_font_atlas = nullptr)                                                                                              = 0;
    virtual void DestroyContext(ImGuiContext* ctx = nullptr)                                                                                                                   = 0;
    virtual ImGuiContext* GetCurrentContext(void)                                                                                                                              = 0;
    virtual void SetCurrentContext(ImGuiContext * ctx)                                                                                                                         = 0;
    virtual bool DebugCheckVersionAndDataLayout(const char* version_str, size_t sz_io, size_t sz_style, size_t sz_vec2, size_t sz_vec4, size_t sz_drawvert, size_t sz_drawidx) = 0;
    ...
    virtual void ShowStyleEditor(ImGuiStyle* ref = nullptr) = 0;
    ...
    // Styles
    virtual void StyleColorsDark(ImGuiStyle* dst = nullptr)    = 0;
    virtual void StyleColorsClassic(ImGuiStyle* dst = nullptr) = 0;
    virtual void StyleColorsLight(ImGuiStyle* dst = nullptr)   = 0;
    ...
    // Window Utilities
    virtual bool IsWindowAppearing(void)                      = 0;
    ...
    virtual void SetNextWindowSizeConstraints(const ImVec2& size_min, const ImVec2& size_max, ImGuiSizeCallback custom_callback = nullptr, void* custom_callback_data = nullptr) = 0;
    ...
    virtual void AlignTextToFramePadding(void)                                     = 0;
    ...
    virtual float GetFrameHeightWithSpacing(void)                                  = 0;
    ...
    // Widgets: Text
    virtual void TextUnformatted(const char* text, const char* text_end = nullptr) = 0;
    ...
    virtual void ProgressBar(float fraction, const ImVec2& size_arg = ImVec2(-1, 0), const char* overlay = nullptr)                                                                                                                                               = 0;
    virtual void Bullet(void)                                                                                                                                                                                                                                     = 0;

    // Widgets: Combo Box
    virtual bool BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0)                                                                                            = 0;
    virtual void EndCombo(void)                                                                                                                                                                 = 0;
    ...
    // Widgets: Drags
    virtual bool DragFloat(const char* label, float* v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = u8"%.3f", float power = 1.0f)                                                                           = 0;
    virtual bool DragFloat2(const char* label, float v[2], float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = u8"%.3f", float power = 1.0f)                                                                        = 0;
    virtual bool DragFloat3(const char* label, float v[3], float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = u8"%.3f", float power = 1.0f)                                                                        = 0;
    virtual bool DragFloat4(const char* label, float v[4], float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = u8"%.3f", float power = 1.0f)                                                                        = 0;
    virtual bool DragFloatRange2(const char* label, float* v_current_min, float* v_current_max, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = u8"%.3f", const char* format_max = nullptr, float power = 1.0f) = 0;
    virtual bool DragInt(const char* label, int* v, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = u8"%d")                                                                                                               = 0;
    virtual bool DragInt2(const char* label, int v[2], float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = u8"%d")                                                                                                            = 0;
    virtual bool DragInt3(const char* label, int v[3], float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = u8"%d")                                                                                                            = 0;
    virtual bool DragInt4(const char* label, int v[4], float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = u8"%d")                                                                                                            = 0;
    virtual bool DragIntRange2(const char* label, int* v_current_min, int* v_current_max, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = u8"%d", const char* format_max = nullptr)                                       = 0;
    virtual bool DragScalar(const char* label, ImGuiDataType data_type, void* v, float v_speed, const void* v_min = nullptr, const void* v_max = nullptr, const char* format = nullptr, float power = 1.0f)                                        = 0;
    virtual bool DragScalarN(const char* label, ImGuiDataType data_type, void* v, int components, float v_speed, const void* v_min = nullptr, const void* v_max = nullptr, const char* format = nullptr, float power = 1.0f)                       = 0;

    // Widgets: Sliders
    virtual bool SliderFloat(const char* label, float* v, float v_min, float v_max, const char* format = u8"%.3f", float power = 1.0f)                                                          = 0;
    virtual bool SliderFloat2(const char* label, float v[2], float v_min, float v_max, const char* format = u8"%.3f", float power = 1.0f)                                                       = 0;
    virtual bool SliderFloat3(const char* label, float v[3], float v_min, float v_max, const char* format = u8"%.3f", float power = 1.0f)                                                       = 0;
    virtual bool SliderFloat4(const char* label, float v[4], float v_min, float v_max, const char* format = u8"%.3f", float power = 1.0f)                                                       = 0;
    virtual bool SliderAngle(const char* label, float* v_rad, float v_degrees_min = -360.0f, float v_degrees_max = +360.0f, const char* format = u8"%.0f deg")                                  = 0;
    virtual bool SliderInt(const char* label, int* v, int v_min, int v_max, const char* format = u8"%d")                                                                                        = 0;
    virtual bool SliderInt2(const char* label, int v[2], int v_min, int v_max, const char* format = u8"%d")                                                                                     = 0;
    virtual bool SliderInt3(const char* label, int v[3], int v_min, int v_max, const char* format = u8"%d")                                                                                     = 0;
    virtual bool SliderInt4(const char* label, int v[4], int v_min, int v_max, const char* format = u8"%d")                                                                                     = 0;
    virtual bool SliderScalar(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format = nullptr, float power = 1.0f)                      = 0;
    virtual bool SliderScalarN(const char* label, ImGuiDataType data_type, void* v, int components, const void* v_min, const void* v_max, const char* format = nullptr, float power = 1.0f)     = 0;
    virtual bool VSliderFloat(const char* label, const ImVec2& size, float* v, float v_min, float v_max, const char* format = u8"%.3f", float power = 1.0f)                                     = 0;
    virtual bool VSliderInt(const char* label, const ImVec2& size, int* v, int v_min, int v_max, const char* format = u8"%d")                                                                   = 0;
    virtual bool VSliderScalar(const char* label, const ImVec2& size, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format = nullptr, float power = 1.0f) = 0;

    // Widgets: Input With Keyboard
    virtual bool InputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = nullptr, void* user_data = nullptr)                                               = 0;
    virtual bool InputTextMultiline(const char* label, char* buf, size_t buf_size, const ImVec2& size = ImVec2(0, 0), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = nullptr, void* user_data = nullptr)   = 0;
    virtual bool InputTextWithHint(const char* label, const char* hint, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = nullptr, void* user_data = nullptr)                     = 0;
    virtual bool InputFloat(const char* label, float* v, float step = 0.0f, float step_fast = 0.0f, const char* format = u8"%.3f", ImGuiInputTextFlags flags = 0)                                                            = 0;
    virtual bool InputFloat2(const char* label, float v[2], const char* format = u8"%.3f", ImGuiInputTextFlags flags = 0)                                                                                                    = 0;
    virtual bool InputFloat3(const char* label, float v[3], const char* format = u8"%.3f", ImGuiInputTextFlags flags = 0)                                                                                                    = 0;
    virtual bool InputFloat4(const char* label, float v[4], const char* format = u8"%.3f", ImGuiInputTextFlags flags = 0)                                                                                                    = 0;
    ...
    virtual bool InputDouble(const char* label, double* v, double step = 0.0, double step_fast = 0.0, const char* format = u8"%.6f", ImGuiInputTextFlags flags = 0)                                                          = 0;
    virtual bool InputScalar(const char* label, ImGuiDataType data_type, void* v, const void* step = nullptr, const void* step_fast = nullptr, const char* format = nullptr, ImGuiInputTextFlags flags = 0)                  = 0;
    virtual bool InputScalarN(const char* label, ImGuiDataType data_type, void* v, int components, const void* step = nullptr, const void* step_fast = nullptr, const char* format = nullptr, ImGuiInputTextFlags flags = 0) = 0;
    ...
    virtual bool ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags = 0, const float* ref_col = nullptr)   = 0;
    ...
    virtual void TreePush(const void* ptr_id = nullptr)                                                   = 0;
    ...
    virtual void PlotLines(const char* label, const float* values, int values_count, int values_offset = 0, const char* overlay_text = nullptr, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0), int stride = sizeof(float))             = 0;
    virtual void PlotLines(const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset = 0, const char* overlay_text = nullptr, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0))     = 0;
    virtual void PlotHistogram(const char* label, const float* values, int values_count, int values_offset = 0, const char* overlay_text = nullptr, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0), int stride = sizeof(float))         = 0;
    virtual void PlotHistogram(const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset = 0, const char* overlay_text = nullptr, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0)) = 0;
    ...
    virtual void Value(const char* prefix, float v, const char* float_format = nullptr) = 0;
    ...
    virtual bool BeginPopupContextItem(const char* str_id = nullptr, int mouse_button = 1)                                = 0;
    virtual bool BeginPopupContextWindow(const char* str_id = nullptr, int mouse_button = 1, bool also_over_items = true) = 0;
    virtual bool BeginPopupContextVoid(const char* str_id = nullptr, int mouse_button = 1)                                = 0;
    virtual bool BeginPopupModal(const char* name, bool* p_open = nullptr, ImGuiWindowFlags flags = 0)                    = 0;
    virtual void EndPopup(void)                                                                                           = 0;
    virtual bool OpenPopupOnItemClick(const char* str_id = nullptr, int mouse_button = 1)                                 = 0;
    virtual bool IsPopupOpen(const char* str_id)                                                                          = 0;
    ...
    virtual void EndTabBar(void)                                                                      = 0;
    virtual bool BeginTabItem(const char* label, bool* p_open = nullptr, ImGuiTabItemFlags flags = 0) = 0;
    virtual void EndTabItem(void)                                                                     = 0;
    virtual void SetTabItemClosed(const char* tab_or_docked_window_label)                             = 0;

    // Logging and Capture
    virtual void LogToTTY(int auto_open_depth = -1)                                  = 0;
    virtual void LogToFile(int auto_open_depth = -1, const char* filename = nullptr) = 0;
    ...
    virtual bool SetDragDropPayload(const char* type, const void* data, size_t sz, ImGuiCond cond = 0) = 0;
    virtual void EndDragDropSource(void)                                                               = 0;
    virtual bool BeginDragDropTarget(void)                                                             = 0;
    virtual const ImGuiPayload* AcceptDragDropPayload(const char* type, ImGuiDragDropFlags flags = 0)  = 0;
    virtual void EndDragDropTarget(void)                                                               = 0;
    virtual const ImGuiPayload* GetDragDropPayload(void)                                               = 0;
    ...
    virtual void SetItemDefaultFocus(void)            = 0;
    ...
    virtual bool IsItemFocused(void)                        = 0;
    virtual bool IsItemClicked(int mouse_button = 0)        = 0;
    virtual bool IsItemVisible(void)                        = 0;
    virtual bool IsItemEdited(void)                         = 0;
    virtual bool IsItemActivated(void)                      = 0;
    virtual bool IsItemDeactivated(void)                    = 0;
    virtual bool IsItemDeactivatedAfterEdit(void)           = 0;
    virtual bool IsAnyItemHovered(void)                     = 0;
    virtual bool IsAnyItemActive(void)                      = 0;
    virtual bool IsAnyItemFocused(void)                     = 0;
    ...
    virtual ImDrawList* GetBackgroundDrawList(void)                                                                                                   = 0;
    virtual ImDrawList* GetForegroundDrawList(void)                                                                                                   = 0;
    virtual ImDrawListSharedData* GetDrawListSharedData(void)                                                                                         = 0;
    ...
    virtual ImVec2 CalcTextSize(const char* text, const char* text_end = nullptr, bool hide_text_after_double_hash = false, float wrap_width = -1.0f) = 0;
    ...
    virtual int GetKeyPressedAmount(int key_index, float repeat_delay, float rate)               = 0;
    virtual bool IsMouseDown(int button)                                                         = 0;
    virtual bool IsAnyMouseDown(void)                                                            = 0;
    ...
    virtual bool IsMousePosValid(const ImVec2* mouse_pos = nullptr)                              = 0;
    ...
    virtual void CaptureKeyboardFromApp(bool want_capture_keyboard_value = true)                 = 0;
    ...
    virtual void LoadIniSettingsFromMemory(const char* ini_data, size_t ini_size = 0) = 0;
    virtual void SaveIniSettingsToDisk(const char* ini_filename)                      = 0;
    virtual const char* SaveIniSettingsToMemory(size_t* out_ini_size = nullptr)       = 0;

    // Memory Allocators
    virtual void SetAllocatorFunctions(void* (*alloc_func)(size_t sz, void* user_data), void (*free_func)(void* ptr, void* user_data), void* user_data = nullptr) = 0;
...
{
    IMGUI_API ImGuiTextFilter(const char* default_filter = u8"");
    IMGUI_API bool Draw(const char* label = u8"Filter (inc,-exc)", float width = 0.0f); // Helper calling InputText+Build
...
struct ImFont
{
    ...
    {
        return ConfigData ? ConfigData->Name : u8"<unknown>";
    }
...
#endif // __ASHITA_SDK_IMGUI_H_INCLUDED__